...
) or {"deepseek/deepseek-v4-pro", "deepseek-v3", "deepseek/deepseek-v4-flash-vision-exp", "deepseek/deepseek-v4.1-flash"}  # v3/视觉实验版排除：视觉模型图片按尺寸换算 token、最坏成本高；v4.1-flash 成本未实测、最坏可能超年卡盈亏线，先排除待账单校准
