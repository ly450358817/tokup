...
const DEFAULT_MODELS: ModelPrice[] = [
  ...
  { id: 'openai/gpt-5.4', name: 'GPT-5.4', provider: 'OpenAI', input: '¥45', output: '¥202', note: '新一代旗舰', badge: 'New' },
  { id: 'openai/gpt-5-mini', name: 'GPT-5-mini', provider: 'OpenAI', input: '¥3.0', output: '¥19', note: '轻量快速', badge: 'New' },
  { id: 'gpt-oss-120b', name: 'GPT-OSS 120B', provider: 'OpenAI', input: '¥2.0', output: '¥8.0', note: '开源高性价比', badge: 'New' },
  { id: 'anthropic/claude-fable-5', name: 'Claude Fable 5', provider: 'Anthropic', input: '¥90', output: '¥500', note: '最新 Claude', badge: 'New' },
  { id: 'claude-4.7-opus', name: 'Claude 4.7 Opus', provider: 'Anthropic', input: '¥45', output: '¥225', note: '最新旗舰 Opus', badge: 'New' },
  ...
  { id: 'deepseek/deepseek-v4.1-flash', name: 'DeepSeek V4.1 Flash', provider: 'DeepSeek', input: '¥4.0', output: '¥12.0', note: '新一代高速 · 实验版', badge: 'New' },
  { id: 'deepseek/deepseek-v3.2', name: 'DeepSeek V3.2', provider: 'DeepSeek', input: '¥3.0', output: '¥4.0', note: '达GPT-5水平', badge: 'New' },
  { id: 'deepseek-v3', name: 'DeepSeek V3', provider: 'DeepSeek', input: '¥3.0', output: '¥11.0', note: '通用模型', badge: '' },
  { id: 'deepseek-r1', name: 'DeepSeek R1', provider: 'DeepSeek', input: '¥6.0', output: '¥21.0', note: '深度推理', badge: '' },
  ...
  { id: 'qwen/qwen3.7-max', name: 'Qwen 3.7 Max', provider: '通义千问', input: '¥16', output: '¥48', note: '通义旗舰', badge: '' },
  { id: 'qwen/qwen3.7-plus', name: 'Qwen 3.7 Plus', provider: '通义千问', input: '¥8', output: '¥32', note: '高性价比中杯', badge: 'New' },
  { id: 'qwen/qwen3.8-flash-next', name: 'Qwen3.8 Flash', provider: '通义千问', input: '¥1.5', output: '¥4.0', note: '高性价比 · 1M上下文', badge: 'New' },
  ...
  { id: 'moonshotai/kimi-k2.6', name: 'Kimi K2.6', provider: '月之暗面', input: '¥9', output: '¥36', note: '稳定可靠', badge: '' },
  ...
  { id: 'tencent/hy4-preview', name: '混元 Hy4 Preview', provider: '腾讯混元', input: '¥8', output: '¥24', note: '1M 上下文 · 代码/智能体', badge: 'New' },
];
